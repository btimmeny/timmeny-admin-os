...
def test_bulk_update_todo_action_metadata_json_accepts_updates_array(monkeypatch):
    requests = []
...
def test_bulk_update_todo_action_metadata_json_accepts_updates_json_array(monkeypatch):
    requests = []
